...
public class Detective {
    ...
    public Detective(Long id, String badgeNumber, Rank rank, boolean armed, EmploymentStatus status, Set<CriminalCase> criminalCases, Set<TrackEntry> trackEntries) {
        this.id = id;
